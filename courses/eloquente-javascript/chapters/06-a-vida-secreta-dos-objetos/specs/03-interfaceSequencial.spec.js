const ArraySeq = require('../scripts/03-interfaceSequencial').ArraySeq,
    RangeSeq = require('../scripts/03-interfaceSequencial').RangeSeq,
    logFive = require('../scripts/03-interfaceSequencial').logFive;
